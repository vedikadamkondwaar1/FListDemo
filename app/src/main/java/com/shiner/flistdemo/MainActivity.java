            ...
            mUploadTask = fileReference.putFile(mImageUri)
                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            Toast.makeText(MainActivity.this, "Upload successful", Toast.LENGTH_LONG).show();          //new replaced method
                            ...
                            Upload upload = new Upload(mEditTextFileName.getText().toString().trim(), mEditTextPrice.getText().toString().trim(), mEditTextDesc.getText().toString().trim(),downloadUrl.toString());
